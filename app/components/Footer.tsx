    ...
    <footer className="bg-gray-200 text-black py-10">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              {data.quickLinks.map((link: FieldsType) => {
                return (
                  <div key={link.sys.id}>
                    <Link
                      className="hover:text-white text-gray-600 transition duration-300 mb-2 "
          ...
          {/* Contact Information */}
          <div className="prose prose-headings:m-0 prose-headings:text-lg prose-headings:text-black prose-p:text-gray-600 space-y-2">
